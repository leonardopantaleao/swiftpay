...
public func mock(_ type: SwiftPay.AppDelegate.Type, file: StaticString = #file, line: UInt = #line) -> AppDelegateMock {
  fatalError()
}

// MARK: - Mocked ClientProtocol

public final class ClientProtocolMock: SwiftPay.ClientProtocol, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public var `responseHandler`: SwiftPay.ResponseHandler {
    get {
      let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "responseHandler.get", arguments: [], returnType: Swift.ObjectIdentifier((SwiftPay.ResponseHandler).self))
      return self.mockingContext.didInvoke(invocation) { () -> SwiftPay.ResponseHandler in
        let implementation = self.stubbingContext.implementation(for: invocation)
        if let concreteImplementation = implementation as? () -> SwiftPay.ResponseHandler {
          return concreteImplementation()
        } else if let defaultValue = self.stubbingContext.defaultValueProvider.provideValue(for: (SwiftPay.ResponseHandler).self) {
          return defaultValue
        } else {
    ...
    set {
      ...
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (SwiftPay.ResponseHandler) -> Void {
  ...
  public func getResponseHandler() -> Mockingbird.Mockable<Mockingbird.PropertyGetterDeclaration, () -> SwiftPay.ResponseHandler, SwiftPay.ResponseHandler> {
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "responseHandler.get", arguments: [], returnType: Swift.ObjectIdentifier((SwiftPay.ResponseHandler).self))
    return Mockingbird.Mockable<Mockingbird.PropertyGetterDeclaration, () -> SwiftPay.ResponseHandler, SwiftPay.ResponseHandler>(mock: self, invocation: invocation)
  }

  public func setResponseHandler(_ newValue: @escaping @autoclosure () -> SwiftPay.ResponseHandler) -> Mockingbird.Mockable<Mockingbird.PropertySetterDeclaration, (SwiftPay.ResponseHandler) -> Void, Void> {
    ...
    return Mockingbird.Mockable<Mockingbird.PropertySetterDeclaration, (SwiftPay.ResponseHandler) -> Void, Void>(mock: self, invocation: invocation)
  }
  ...
  // MARK: Mocked `getTransactionsBalance`(_ `email`: String?, `completionHandler`: @escaping (Result<Double, SwiftPay.ValidationError>) -> ())

  public func `getTransactionsBalance`(_ `email`: String?, `completionHandler`: @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void {
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`getTransactionsBalance`(_ `email`: String?, `completionHandler`: @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void", arguments: [Mockingbird.ArgumentMatcher(`email`), Mockingbird.ArgumentMatcher(`completionHandler`)], returnType: Swift.ObjectIdentifier((Void).self))
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void {
  ...
  public func `getTransactionsBalance`(_ `email`: @escaping @autoclosure () -> String?, `completionHandler`: @escaping @autoclosure () -> (Result<Double, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    let arguments: [Mockingbird.ArgumentMatcher] = [Mockingbird.resolve(`email`), Mockingbird.resolve(`completionHandler`)]
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`getTransactionsBalance`(_ `email`: String?, `completionHandler`: @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, @escaping (Result<Double, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }

  // MARK: Mocked `getUserInfo`(_ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ())

  public func `getUserInfo`(_ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`getUserInfo`(_ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: [Mockingbird.ArgumentMatcher(`email`), Mockingbird.ArgumentMatcher(`completionHandler`)], returnType: Swift.ObjectIdentifier((Void).self))
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
        concreteImplementation(`email`, `completionHandler`)
      } else if let concreteImplementation = implementation as? () -> Void {
        concreteImplementation()
      }
  ...
  public func `getUserInfo`(_ `email`: @escaping @autoclosure () -> String?, `completionHandler`: @escaping @autoclosure () -> (Result<String, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    let arguments: [Mockingbird.ArgumentMatcher] = [Mockingbird.resolve(`email`), Mockingbird.resolve(`completionHandler`)]
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`getUserInfo`(_ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }

  // MARK: Mocked `signIn`(_ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ())

  public func `signIn`(_ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
    ...
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
  ...
  public func `signIn`(_ `email`: @escaping @autoclosure () -> String?, _ `password`: @escaping @autoclosure () -> String?, `completionHandler`: @escaping @autoclosure () -> (Result<String, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    ...
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`signIn`(_ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }

  // MARK: Mocked `createUserOnDB`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ())

  public func `createUserOnDB`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
    ...
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
  ...
  public func `createUserOnDB`(_ `name`: @escaping @autoclosure () -> String?, _ `lastName`: @escaping @autoclosure () -> String?, _ `email`: @escaping @autoclosure () -> String?, `completionHandler`: @escaping @autoclosure () -> (Result<String, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    ...
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`createUserOnDB`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }

  // MARK: Mocked `signUp`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ())

  public func `signUp`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
    ...
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
  ...
  public func `signUp`(_ `name`: @escaping @autoclosure () -> String?, _ `lastName`: @escaping @autoclosure () -> String?, _ `email`: @escaping @autoclosure () -> String?, _ `password`: @escaping @autoclosure () -> String?, `completionHandler`: @escaping @autoclosure () -> (Result<String, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    ...
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`signUp`(_ `name`: String?, _ `lastName`: String?, _ `email`: String?, _ `password`: String?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, String?, String?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }

  // MARK: Mocked `performTransaction`(_ `senderEmail`: String?, _ `receiverEmail`: String?, _ `amount`: Double?, _ `transactionType`: String?, _ `transactionDate`: TimeInterval?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ())

  public func `performTransaction`(_ `senderEmail`: String?, _ `receiverEmail`: String?, _ `amount`: Double?, _ `transactionType`: String?, _ `transactionDate`: TimeInterval?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
    ...
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? (String?, String?, Double?, String?, TimeInterval?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void {
  ...
  public func `performTransaction`(_ `senderEmail`: @escaping @autoclosure () -> String?, _ `receiverEmail`: @escaping @autoclosure () -> String?, _ `amount`: @escaping @autoclosure () -> Double?, _ `transactionType`: @escaping @autoclosure () -> String?, _ `transactionDate`: @escaping @autoclosure () -> TimeInterval?, `completionHandler`: @escaping @autoclosure () -> (Result<String, SwiftPay.ValidationError>) -> ()) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, Double?, String?, TimeInterval?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void> {
    ...
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`performTransaction`(_ `senderEmail`: String?, _ `receiverEmail`: String?, _ `amount`: Double?, _ `transactionType`: String?, _ `transactionDate`: TimeInterval?, `completionHandler`: @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (String?, String?, Double?, String?, TimeInterval?, @escaping (Result<String, SwiftPay.ValidationError>) -> ()) -> Void, Void>(mock: self, invocation: invocation)
  }
}

/// Returns a concrete mock of `ClientProtocol`.
public func mock(_ type: SwiftPay.ClientProtocol.Protocol, file: StaticString = #file, line: UInt = #line) -> ClientProtocolMock {
  return ClientProtocolMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked DepositPresenter

public final class DepositPresenterMock: SwiftPay.DepositPresenter, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    public static func initialize(`viewDelegate`: SwiftPay.DepositViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService, __file: StaticString = #file, __line: UInt = #line) -> DepositPresenterMock { fatalError("See 'Thunk Pruning' in the README") }
  }

  // MARK: Mocked client

  override public var `client`: SwiftPay.ClientProtocol { get { fatalError("See 'Thunk Pruning' in the README") } set { fatalError("See 'Thunk Pruning' in the README") } }

  public func getClient() -> Mockingbird.Mockable<Mockingbird.PropertyGetterDeclaration, () -> SwiftPay.ClientProtocol, SwiftPay.ClientProtocol> { fatalError("See 'Thunk Pruning' in the README") }

  public func setClient(_ newValue: @escaping @autoclosure () -> SwiftPay.ClientProtocol) -> Mockingbird.Mockable<Mockingbird.PropertySetterDeclaration, (SwiftPay.ClientProtocol) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }
  ...
  override public var `validationService`: SwiftPay.ValidationService { get { fatalError("See 'Thunk Pruning' in the README") } set { fatalError("See 'Thunk Pruning' in the README") } }

  public func getValidationService() -> Mockingbird.Mockable<Mockingbird.PropertyGetterDeclaration, () -> SwiftPay.ValidationService, SwiftPay.ValidationService> { fatalError("See 'Thunk Pruning' in the README") }

  public func setValidationService(_ newValue: @escaping @autoclosure () -> SwiftPay.ValidationService) -> Mockingbird.Mockable<Mockingbird.PropertySetterDeclaration, (SwiftPay.ValidationService) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }
  ...
  // MARK: Mocked `setViewDelegate`(_ `viewDelegate`: SwiftPay.DepositViewDelegate)

  public override func `setViewDelegate`(_ `viewDelegate`: SwiftPay.DepositViewDelegate) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setViewDelegate`(_ `viewDelegate`: @escaping @autoclosure () -> SwiftPay.DepositViewDelegate) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (SwiftPay.DepositViewDelegate) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }

  // MARK: Mocked init(`viewDelegate`: SwiftPay.DepositViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService)

  public required override init(`viewDelegate`: SwiftPay.DepositViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService) { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(DepositPresenter.self).initialize(…)`.
public func mock(_ type: SwiftPay.DepositPresenter.Type, file: StaticString = #file, line: UInt = #line) -> DepositPresenterMock.InitializerProxy.Type {
  return DepositPresenterMock.InitializerProxy.self
}

// MARK: - Mocked DepositViewController

public final class DepositViewControllerMock: SwiftPay.DepositViewController, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    ...
    public static func initialize(`presenter`: SwiftPay.DepositPresenter, __file: StaticString = #file, __line: UInt = #line) -> DepositViewControllerMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked init(`presenter`: SwiftPay.DepositPresenter)

  public required override init(`presenter`: SwiftPay.DepositPresenter) { fatalError("See 'Thunk Pruning' in the README") }
...
public func mock(_ type: SwiftPay.DepositViewController.Type, file: StaticString = #file, line: UInt = #line) -> DepositViewControllerMock.InitializerProxy.Type {
  return DepositViewControllerMock.InitializerProxy.self
}

// MARK: - Mocked DepositViewDelegate

public final class DepositViewDelegateMock: SwiftPay.DepositViewDelegate, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.DepositViewDelegate.Protocol, file: StaticString = #file, line: UInt = #line) -> DepositViewDelegateMock {
...
public func mock(_ type: SwiftPay.HomeViewController.Type, file: StaticString = #file, line: UInt = #line) -> HomeViewControllerMock {
  fatalError()
}

// MARK: - Mocked MoneyTransactionTableViewCell

public final class MoneyTransactionTableViewCellMock: SwiftPay.MoneyTransactionTableViewCell, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.MoneyTransactionTableViewCell.Type, file: StaticString = #file, line: UInt = #line) -> MoneyTransactionTableViewCellMock.InitializerProxy.Type {
  return MoneyTransactionTableViewCellMock.InitializerProxy.self
}

// MARK: - Mocked ObjectSavable

public final class ObjectSavableMock: SwiftPay.ObjectSavable, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.ObjectSavable.Protocol, file: StaticString = #file, line: UInt = #line) -> ObjectSavableMock {
...
public func mock(_ type: SwiftPay.SceneDelegate.Type, file: StaticString = #file, line: UInt = #line) -> SceneDelegateMock {
  fatalError()
}
...
public final class SignInPresenterMock: SwiftPay.SignInPresenter, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    public static func initialize(`signInViewDelagate`: SwiftPay.SignInViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol, __file: StaticString = #file, __line: UInt = #line) -> SignInPresenterMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked `setViewDelegate`(`signInViewDelagate`: SwiftPay.SignInViewDelegate?)

  public override func `setViewDelegate`(`signInViewDelagate`: SwiftPay.SignInViewDelegate?) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setViewDelegate`(`signInViewDelagate`: @escaping @autoclosure () -> SwiftPay.SignInViewDelegate?) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (SwiftPay.SignInViewDelegate?) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }

  // MARK: Mocked init(`signInViewDelagate`: SwiftPay.SignInViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol)

  public required override init(`signInViewDelagate`: SwiftPay.SignInViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol) { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(SignInPresenter.self).initialize(…)`.
public func mock(_ type: SwiftPay.SignInPresenter.Type, file: StaticString = #file, line: UInt = #line) -> SignInPresenterMock.InitializerProxy.Type {
  return SignInPresenterMock.InitializerProxy.self
}

// MARK: - Mocked SignInViewController

public final class SignInViewControllerMock: SwiftPay.SignInViewController, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    ...
    public static func initialize(`signInPresenter`: SwiftPay.SignInPresenter, __file: StaticString = #file, __line: UInt = #line) -> SignInViewControllerMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked init(`signInPresenter`: SwiftPay.SignInPresenter)

  public required override init(`signInPresenter`: SwiftPay.SignInPresenter) { fatalError("See 'Thunk Pruning' in the README") }
...
public func mock(_ type: SwiftPay.SignInViewController.Type, file: StaticString = #file, line: UInt = #line) -> SignInViewControllerMock.InitializerProxy.Type {
  return SignInViewControllerMock.InitializerProxy.self
}

// MARK: - Mocked SignInViewDelegate

public final class SignInViewDelegateMock: SwiftPay.SignInViewDelegate, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.SignInViewDelegate.Protocol, file: StaticString = #file, line: UInt = #line) -> SignInViewDelegateMock {
  return SignInViewDelegateMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked SignUpPresenter

public final class SignUpPresenterMock: SwiftPay.SignUpPresenter, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    public static func initialize(`signUpViewDelegate`: SwiftPay.SignUpViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol, __file: StaticString = #file, __line: UInt = #line) -> SignUpPresenterMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked `setViewDelegate`(`signUpViewDelagate`: SwiftPay.SignUpViewDelegate?)

  public override func `setViewDelegate`(`signUpViewDelagate`: SwiftPay.SignUpViewDelegate?) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setViewDelegate`(`signUpViewDelagate`: @escaping @autoclosure () -> SwiftPay.SignUpViewDelegate?) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (SwiftPay.SignUpViewDelegate?) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }

  // MARK: Mocked init(`signUpViewDelegate`: SwiftPay.SignUpViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol)

  public required override init(`signUpViewDelegate`: SwiftPay.SignUpViewDelegate?, `validationService`: SwiftPay.ValidationService, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol) { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(SignUpPresenter.self).initialize(…)`.
public func mock(_ type: SwiftPay.SignUpPresenter.Type, file: StaticString = #file, line: UInt = #line) -> SignUpPresenterMock.InitializerProxy.Type {
  return SignUpPresenterMock.InitializerProxy.self
}

// MARK: - Mocked SignUpViewController

public final class SignUpViewControllerMock: SwiftPay.SignUpViewController, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    ...
    public static func initialize(`signUpPresenter`: SwiftPay.SignUpPresenter, __file: StaticString = #file, __line: UInt = #line) -> SignUpViewControllerMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked init(`signUpPresenter`: SwiftPay.SignUpPresenter)

  public required override init(`signUpPresenter`: SwiftPay.SignUpPresenter) { fatalError("See 'Thunk Pruning' in the README") }
...
public func mock(_ type: SwiftPay.SignUpViewController.Type, file: StaticString = #file, line: UInt = #line) -> SignUpViewControllerMock.InitializerProxy.Type {
  return SignUpViewControllerMock.InitializerProxy.self
}

// MARK: - Mocked SignUpViewDelegate

public final class SignUpViewDelegateMock: SwiftPay.SignUpViewDelegate, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.SignUpViewDelegate.Protocol, file: StaticString = #file, line: UInt = #line) -> SignUpViewDelegateMock {
  return SignUpViewDelegateMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked TransferPresenter

public final class TransferPresenterMock: SwiftPay.TransferPresenter, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    public static func initialize(`viewDelegate`: SwiftPay.TransferViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService, __file: StaticString = #file, __line: UInt = #line) -> TransferPresenterMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked `setViewDelegate`(_ `viewDelegate`: SwiftPay.TransferViewDelegate)

  public override func `setViewDelegate`(_ `viewDelegate`: SwiftPay.TransferViewDelegate) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setViewDelegate`(_ `viewDelegate`: @escaping @autoclosure () -> SwiftPay.TransferViewDelegate) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (SwiftPay.TransferViewDelegate) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }

  // MARK: Mocked init(`viewDelegate`: SwiftPay.TransferViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService)

  public required override init(`viewDelegate`: SwiftPay.TransferViewDelegate?, `userDefaults`: SwiftPay.UserDefaultsProtocol, `client`: SwiftPay.ClientProtocol, `validationService`: SwiftPay.ValidationService) { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(TransferPresenter.self).initialize(…)`.
public func mock(_ type: SwiftPay.TransferPresenter.Type, file: StaticString = #file, line: UInt = #line) -> TransferPresenterMock.InitializerProxy.Type {
  return TransferPresenterMock.InitializerProxy.self
}

// MARK: - Mocked TransferViewController

public final class TransferViewControllerMock: SwiftPay.TransferViewController, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    ...
    public static func initialize(`presenter`: SwiftPay.TransferPresenter, __file: StaticString = #file, __line: UInt = #line) -> TransferViewControllerMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  // MARK: Mocked init(`presenter`: SwiftPay.TransferPresenter)

  public required override init(`presenter`: SwiftPay.TransferPresenter) { fatalError("See 'Thunk Pruning' in the README") }
...
public func mock(_ type: SwiftPay.TransferViewController.Type, file: StaticString = #file, line: UInt = #line) -> TransferViewControllerMock.InitializerProxy.Type {
  return TransferViewControllerMock.InitializerProxy.self
}

// MARK: - Mocked TransferViewDelegate

public final class TransferViewDelegateMock: SwiftPay.TransferViewDelegate, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.TransferViewDelegate.Protocol, file: StaticString = #file, line: UInt = #line) -> TransferViewDelegateMock {
  return TransferViewDelegateMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked UserDefaultsProtocol

public final class UserDefaultsProtocolMock: SwiftPay.UserDefaultsProtocol, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.UserDefaultsProtocol.Protocol, file: StaticString = #file, line: UInt = #line) -> UserDefaultsProtocolMock {
  return UserDefaultsProtocolMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked UserInfoDelegate

public final class UserInfoDelegateMock: SwiftPay.UserInfoDelegate, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  // MARK: Mocked `setTransactionsTable`(_ `moneyTransactions`: [SwiftPay.MoneyTransaction]?)

  public func `setTransactionsTable`(_ `moneyTransactions`: [SwiftPay.MoneyTransaction]?) -> Void {
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`setTransactionsTable`(_ `moneyTransactions`: [SwiftPay.MoneyTransaction]?) -> Void", arguments: [Mockingbird.ArgumentMatcher(`moneyTransactions`)], returnType: Swift.ObjectIdentifier((Void).self))
    self.mockingContext.didInvoke(invocation) { () -> Void in
      let implementation = self.stubbingContext.implementation(for: invocation)
      if let concreteImplementation = implementation as? ([SwiftPay.MoneyTransaction]?) -> Void {
  ...
  public func `setTransactionsTable`(_ `moneyTransactions`: @escaping @autoclosure () -> [SwiftPay.MoneyTransaction]?) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, ([SwiftPay.MoneyTransaction]?) -> Void, Void> {
    let arguments: [Mockingbird.ArgumentMatcher] = [Mockingbird.resolve(`moneyTransactions`)]
    let invocation: Mockingbird.Invocation = Mockingbird.Invocation(selectorName: "`setTransactionsTable`(_ `moneyTransactions`: [SwiftPay.MoneyTransaction]?) -> Void", arguments: arguments, returnType: Swift.ObjectIdentifier((Void).self))
    return Mockingbird.Mockable<Mockingbird.FunctionDeclaration, ([SwiftPay.MoneyTransaction]?) -> Void, Void>(mock: self, invocation: invocation)
  }
}

/// Returns a concrete mock of `UserInfoDelegate`.
public func mock(_ type: SwiftPay.UserInfoDelegate.Protocol, file: StaticString = #file, line: UInt = #line) -> UserInfoDelegateMock {
  return UserInfoDelegateMock(sourceLocation: Mockingbird.SourceLocation(file, line))
}

// MARK: - Mocked UserInfoPresenter

public final class UserInfoPresenterMock: SwiftPay.UserInfoPresenter, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    public static func initialize(`userInfoDelegate`: SwiftPay.UserInfoDelegate?, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol, __file: StaticString = #file, __line: UInt = #line) -> UserInfoPresenterMock { fatalError("See 'Thunk Pruning' in the README") }
  }
  ...
  public override func `setViewDelegate`(`userInfoDelegate`: SwiftPay.UserInfoDelegate?) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setViewDelegate`(`userInfoDelegate`: @escaping @autoclosure () -> SwiftPay.UserInfoDelegate?) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, (SwiftPay.UserInfoDelegate?) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }

  // MARK: Mocked init(`userInfoDelegate`: SwiftPay.UserInfoDelegate?, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol)

  public required override init(`userInfoDelegate`: SwiftPay.UserInfoDelegate?, `client`: SwiftPay.ClientProtocol, `userDefaults`: SwiftPay.UserDefaultsProtocol) { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(UserInfoPresenter.self).initialize(…)`.
public func mock(_ type: SwiftPay.UserInfoPresenter.Type, file: StaticString = #file, line: UInt = #line) -> UserInfoPresenterMock.InitializerProxy.Type {
  return UserInfoPresenterMock.InitializerProxy.self
}

// MARK: - Mocked UserInfoViewController

public final class UserInfoViewControllerMock: SwiftPay.UserInfoViewController, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
  ...
  public enum InitializerProxy {
    ...
    public static func initialize(`userInfoPresenter`: SwiftPay.UserInfoPresenter, __file: StaticString = #file, __line: UInt = #line) -> UserInfoViewControllerMock { fatalError("See 'Thunk Pruning' in the README") }
  }

  // MARK: Mocked transactions

  override public var `transactions`: [SwiftPay.MoneyTransaction] { get { fatalError("See 'Thunk Pruning' in the README") } set { fatalError("See 'Thunk Pruning' in the README") } }

  public func getTransactions() -> Mockingbird.Mockable<Mockingbird.PropertyGetterDeclaration, () -> [SwiftPay.MoneyTransaction], [SwiftPay.MoneyTransaction]> { fatalError("See 'Thunk Pruning' in the README") }

  public func setTransactions(_ newValue: @escaping @autoclosure () -> [SwiftPay.MoneyTransaction]) -> Mockingbird.Mockable<Mockingbird.PropertySetterDeclaration, ([SwiftPay.MoneyTransaction]) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }
  ...
  // MARK: Mocked init(`userInfoPresenter`: SwiftPay.UserInfoPresenter)

  public required override init(`userInfoPresenter`: SwiftPay.UserInfoPresenter) { fatalError("See 'Thunk Pruning' in the README") }
  ...
  public override func `setTransactionsTable`(_ `moneyTransactions`: [SwiftPay.MoneyTransaction]?) -> Void { fatalError("See 'Thunk Pruning' in the README") }

  public func `setTransactionsTable`(_ `moneyTransactions`: @escaping @autoclosure () -> [SwiftPay.MoneyTransaction]?) -> Mockingbird.Mockable<Mockingbird.FunctionDeclaration, ([SwiftPay.MoneyTransaction]?) -> Void, Void> { fatalError("See 'Thunk Pruning' in the README") }
}

/// Returns an abstract mock which should be initialized using `mock(UserInfoViewController.self).initialize(…)`.
public func mock(_ type: SwiftPay.UserInfoViewController.Type, file: StaticString = #file, line: UInt = #line) -> UserInfoViewControllerMock.InitializerProxy.Type {
  return UserInfoViewControllerMock.InitializerProxy.self
}

// MARK: - Mocked Utilities

public final class UtilitiesMock: SwiftPay.Utilities, Mockingbird.Mock {
  static let staticMock = Mockingbird.StaticMock()
  public let mockingContext = Mockingbird.MockingContext()
  public let stubbingContext = Mockingbird.StubbingContext()
  public let mockMetadata = Mockingbird.MockMetadata(["generator_version": "0.16.0", "module_name": "SwiftPay"])
...
public func mock(_ type: SwiftPay.Utilities.Type, file: StaticString = #file, line: UInt = #line) -> UtilitiesMock {
